...
System.out.println("Current Balance  of" + this.acname + " after withdrawl of Rs."+bal+" is " + balance);
...
this.balance = this.balance + bal;
System.out.println("Current Balance of " + this.acname + " after Deposit of Rs."+bal+" is "+balance);
...
BankAccount account1 = new BankAccount(101, "Ross", 8453.20, "Current Account");
BankAccount account2 = new BankAccount(102, "Watson", 9047, "Saving Account");
BankAccount account3 = new BankAccount(103, "Malcom", 10061, "Current Account");
BankAccount account4 = new BankAccount(104, "Stark", 57640, "Saving Account");
